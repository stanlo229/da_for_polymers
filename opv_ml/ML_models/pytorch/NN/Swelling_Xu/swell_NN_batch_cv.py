...
from opv_ml.ML_models.pytorch.data.Swelling_Xu.data_cv import OPVDataModule
...
CHECKPOINT_DIR = pkg_resources.resource_filename(
    "opv_ml", "model_checkpoints/Swelling_Xu/NN"
)

SUMMARY_DIR = pkg_resources.resource_filename(
    "opv_ml", "ML_models/pytorch/NN/Swelling_Xu/opv_NN_batch_cv.csv"
)
