...
from opv_ml.ML_models.sklearn.data.tokenizer import Tokenizer

TRAIN_MASTER_DATA = pkg_resources.resource_filename(
    "opv_ml", "data/postprocess/train_frag_master.csv"
)

CHECKPOINT_DIR = pkg_resources.resource_filename("opv_ml", "model_checkpoints/BRT")
...
ABLATION_STUDY = pkg_resources.resource_filename(
    "opv_ml", "results/ablation_study_r_score.csv"
)
