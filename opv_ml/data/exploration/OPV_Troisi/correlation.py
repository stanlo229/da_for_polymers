...
CORRELATION_PLOT = pkg_resources.resource_filename(
    "opv_ml", "data/exploration/OPV_Troisi/correlation_parity_plot.png"
)

CORRELATION_HEATMAP_PLOT = pkg_resources.resource_filename(
    "opv_ml", "data/exploration/OPV_Troisi/correlation_heatmap_plot.png"
)

RMSE_HEATMAP_PLOT = pkg_resources.resource_filename(
    "opv_ml", "data/exploration/OPV_Troisi/rmse_heatmap_plot.png"
)
