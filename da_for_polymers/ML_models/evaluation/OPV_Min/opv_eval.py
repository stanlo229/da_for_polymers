...
from da_for_polymers.ML_models.pytorch.NN.OPV_Min.opv_NN import NNModel
from da_for_polymers.ML_models.pytorch.LSTM.OPV_Min.opv_LSTM import LSTMModel
...
MODEL_CHECKPOINT = pkg_resources.resource_filename(
    "da_for_polymers", "model_checkpoints/OPV_Min"
)
