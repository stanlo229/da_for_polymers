...
from da_for_polymers.ML_models.pytorch.data.Swelling_Xu.data_cv import OPVDataModule
...
CHECKPOINT_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "model_checkpoints/Swelling_Xu/NN"
)

SUMMARY_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "ML_models/pytorch/NN/Swelling_Xu/opv_NN_batch_cv.csv"
)
...
class NNModel(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_corr_coef", corr_coef, on_epoch=True)
...
def cli_main():
    ...
    for i in range(len(unique_datatype)):
        ...
        for cv in cv_outer:
            ...
            # testing
            # ------------
            test_output = trainer.test(NN_model, data_module, None)
