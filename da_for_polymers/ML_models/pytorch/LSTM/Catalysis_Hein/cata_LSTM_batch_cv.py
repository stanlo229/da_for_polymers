...
from da_for_polymers.ML_models.pytorch.data.OPV_Min.data_cv import OPVDataModule
...
CHECKPOINT_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "model_checkpoints/Catalysis_Hein/NN"
)

SUMMARY_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "ML_models/pytorch/LSTM/Catalysis_Hein/cata_LSTM_batch_cv.csv"
)

CHECKPOINT_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "model_checkpoints/LSTM"
)
