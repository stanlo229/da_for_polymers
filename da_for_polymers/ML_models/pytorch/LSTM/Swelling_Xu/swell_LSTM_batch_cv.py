...
CHECKPOINT_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "model_checkpoints/Swelling_Xu/LSTM"
)

SUMMARY_DIR = pkg_resources.resource_filename(
    "da_for_polymers", "ML_models/pytorch/LSTM/Swelling_Xu/swell_LSTM_batch_cv.csv"
)
...
class LSTMModel(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_corr_coef", corr_coef)
...
def cli_main():
    ...
    for i in range(len(unique_datatype)):
        ...
        for cv in cv_outer:
            ...
            # model
            # ------------
            print("DATA_MODULE: ", data_module.data_size)
