...
IMAGE_PATH = pkg_resources.resource_filename("da_for_polymers", "data/postprocess/")

CLEAN_DONOR_DATA = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/clean_min_donors.csv"
)

CLEAN_ACCEPTOR_DATA = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/clean_min_acceptors.csv"
)

NUM_FRAG_DATA = pkg_resources.resource_filename(
    "da_for_polymers", "data/postprocess/num_of_frag.csv"
)
