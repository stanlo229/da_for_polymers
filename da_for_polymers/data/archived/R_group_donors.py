...
DON_PATH = pkg_resources.resource_filename("da_for_polymers", "min_donors_smiles.txt")
CSV_PATH = pkg_resources.resource_filename(
    "da_for_polymers", "min_donors_smilesRgrp.csv"
)
XLSX_PATH = pkg_resources.resource_filename(
    "da_for_polymers", "Labelling/min_donors_smiles.xlsx"
)
BIGSMILES_PATH = pkg_resources.resource_filename(
    "da_for_polymers", "Labelling/min_donors_big_smiles.csv"
)
