...
CORRELATION_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Troisi/correlation_parity_plot.png"
)

CORRELATION_HEATMAP_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Troisi/correlation_heatmap_plot.png"
)

RMSE_HEATMAP_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Troisi/rmse_heatmap_plot.png"
)
...
class Correlation:
    ...
    def parity_plot(self):
        ...
        for pair in permutations:
            ...
            if not isinstance(filtered_column_0[0], str) or not isinstance(
