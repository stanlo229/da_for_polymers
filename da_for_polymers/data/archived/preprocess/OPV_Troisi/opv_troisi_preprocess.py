...
OPV_TROISI_DATA = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/OPV_Troisi/opv_database.csv"
)

OPV_TROISI_SMILES = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/OPV_Troisi/opv_data_smiles.csv"
)
...
OPV_TROISI_DONORS = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/OPV_Troisi/opv_donors.csv"
)

OPV_TROISI_ACCEPTORS = pkg_resources.resource_filename(
    "da_for_polymers", "data/preprocess/OPV_Troisi/opv_acceptors.csv"
)
