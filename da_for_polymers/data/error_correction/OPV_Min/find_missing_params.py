...
HOMO_D_DISTRIBUTION = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/homo_donor_distribution_plot.png"
)

LUMO_D_DISTRIBUTION = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/lumo_donor_distribution_plot.png"
)

HOMO_A_DISTRIBUTION = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/error_correction/OPV_Min/homo_acceptor_distribution_plot.png",
)

LUMO_A_DISTRIBUTION = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/error_correction/OPV_Min/lumo_acceptor_distribution_plot.png",
)

STATS_D_HOMO = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/stats_homo_donor.csv"
)

STATS_D_LUMO = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/stats_lumo_donor.csv"
)

STATS_A_HOMO = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/stats_homo_acceptor.csv"
)

STATS_A_LUMO = pkg_resources.resource_filename(
    "da_for_polymers", "data/error_correction/OPV_Min/stats_lumo_acceptor.csv"
)
