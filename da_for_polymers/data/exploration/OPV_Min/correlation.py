...
CORRELATION_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Min/correlation_parity_plot.png"
)

CORRELATION_HEATMAP_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Min/correlation_heatmap_plot.png"
)

RMSE_HEATMAP_PLOT = pkg_resources.resource_filename(
    "da_for_polymers", "data/exploration/OPV_Min/rmse_heatmap_plot.png"
)
